...
function videoJS(panerId, src, cb) {
  ...
  setInterval(function () {
    // console.log('state', document.getElementById('my_video').readyState)
    // alert( document.getElementById('my_video').readyState)
  }, 2000)
  __VideoHTML.on('loadedmetadata', function () {
    cb();
  })
}
